...
<head>
    ...
    <title>Inscription - ZenBlog Bootstrap Template</title>
    ...
    <main class="main">
        <section class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form method="post" class="p-2 bg-light rounded shadow">
                        <div class="mb-3">
                            <label for="name" class="form-label">Nom complet</label>
                            <input type="email" name="f_name" class="form-control" id="name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="f_mdp" class="form-control" id="exampleInputPassword1">
                        </div>
                        
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <a href="connection.php" class="ms-5">Connection</a>
